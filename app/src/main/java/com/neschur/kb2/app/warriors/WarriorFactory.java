...
public class WarriorFactory {
    ...
    public static Warrior create(String id) {
        switch (id) {
            ...
            case "druid":
                return new Warrior(id, R.drawable.status_ancientmap_0, 60, 22, 3, false, true, 100, 500);
            case "cannibal":
                return new Warrior(id, R.drawable.status_ancientmap_0, 60, 30, 2, false, false, 100, 700);
            case "ghost":
                return new Warrior(id, R.drawable.status_ancientmap_0, 70, 15, 3, false, false, 100, 600);
            case "lion":
                return new Warrior(id, R.drawable.status_ancientmap_0, 70, 22, 4, false, false, 100, 800);
            case "snake":
                return new Warrior(id, R.drawable.status_ancientmap_0, 70, 65, 1, false, false, 30, 1500);
            case "troll":
                return new Warrior(id, R.drawable.status_ancientmap_0, 100, 25, 1, false, false, 100, 1000);
            case "vampire":
                return new Warrior(id, R.drawable.status_ancientmap_0, 110, 40, 1, true, false, 50, 2000);
            case "giant":
                return new Warrior(id, R.drawable.status_ancientmap_0, 120, 45, 2, false, true, 50, 3000);
            case "elephant":
                return new Warrior(id, R.drawable.status_ancientmap_0, 130, 50, 1, false, false, 50, 2000);
            case "knight":
                return new Warrior(id, R.drawable.status_ancientmap_0, 150, 55, 1, false, false, 70, 3000);
            case "centaur":
                return new Warrior(id, R.drawable.status_ancientmap_0, 400, 200, 3, false, true, 30, 5000);
            case "dinosaur":
                return new Warrior(id, R.drawable.status_ancientmap_0, 450, 200, 2, false, false, 50, 5000);
            case "daemon":
                return new Warrior(id, R.drawable.status_ancientmap_0, 500, 200, 1, true, false, 30, 7000);
            case "cyclops":
                return new Warrior(id, R.drawable.status_ancientmap_0, 600, 400, 2, false, false, 30, 8000);
            case "dragon":
                return new Warrior(id, R.drawable.status_ancientmap_0, 1000, 250, 1, true, false, 30, 10000);
            default:
                return null;
        }
    }
